...
public final class StringHelper
{
    ...
    public static final String TOO_LOW_LEVEL = "Too low level!";
    public static final String BOUGHT_SUCCESSFULLY = "Purchase successfull!";
    public static final String UPGRADE_SUCCESSFULL = "Upgrade successfull!";
